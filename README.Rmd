...
sigstats contains functionality to compute basic signature related statistics. For example, computing cosine similarity of two decompositions.
...
-   [sigvis](https://github.com/selkamand/sigsvis) for signature visualisation
